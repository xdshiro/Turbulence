...
files = [
    {"path": "data\\MSE_spec_part_005.npz", "label": r"Spectre-based MSE. $\sigma_R^2=0.05$."},
    {"path": "data\\MSE_spec_part_015.npz", "label": r"Spectre-based MSE. $\sigma_R^2=0.15$."},
    {"path": "data\\MSE_spec_part_025.npz", "label": r"Spectre-based MSE. $\sigma_R^2=0.25$."},
