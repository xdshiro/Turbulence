...
fig_005.add_trace(go.Bar(
    ...
    name="0.25 Turbulence Strength",
    marker=dict(color='lightblue', line=dict(color='black', width=1)),
    width=width,  # Narrower column width to create more space between columns
))

# Advanced layout customization for a polished scientific look
fig_005.update_layout(
    ...
    # bargap=0.05,      # Smaller gap between bars within each group to reduce overall group spacing
    # bargroupgap=0.05  # Reduce group gap to bring sections closer together
)
