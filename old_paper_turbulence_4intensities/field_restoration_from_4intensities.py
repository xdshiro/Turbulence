...
data = scipy.io.loadmat('Uz_results_test.mat')
...
# Plot the amplitude and phase of the upscaled U_f
plot_field_both(U_f_resized)


# Control pad size
pad_size = (int(U_f_resized.shape[0] * 16), int(U_f_resized.shape[1] * 16))
...
# Plot the amplitude and phase of the 2D FFT of the padded field
...
A = 2
crop_size = int(reso * A) # For example, 100x100
...
# Plot the amplitude and phase of the cropped FFT spectrum
plot_field_both(U_f_fft)


pad_size2 = (int(U_f_fft_cropped.shape[0] * (16 / A)), int(U_f_fft_cropped.shape[1] * (16 / A)))
...
# Plot the amplitude and phase of the IFFT of the cropped field
plot_field_both(U_f_ifft_cropped)

# Define the size of the cropped region for the IFFT result
ifft_crop_size = reso  # For example, 50x50
...
# Plot the amplitude and phase of the IFFT of the final cropped field
...
res_z = 40
field_center = beam_expander(U_f_ifft_cropped_final, beam_par, psh_par_0, distance_both=2200, steps_one=res_z // 2)
